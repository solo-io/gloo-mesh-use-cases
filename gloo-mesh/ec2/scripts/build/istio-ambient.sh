...
required_vars=("CLUSTER_NAME" "ISTIO_IMAGE" "EC2_DOMAIN" "AWS_ACCOUNT" "SOLO_ISTIO_LICENSE_KEY")
...
echo "Next steps: Tag EC2 instances with ec2.solo.io/* labels to enable discovery."
